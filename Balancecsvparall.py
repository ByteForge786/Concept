...
class ConcurrentRateLimiter:
    ...
    def __init__(self, max_concurrent: int = MAX_CONCURRENT_REQUESTS):
        ...
        self.error_window = []
        self.window_size = 10
        self.current_delay = 0.2  # Reduced initial delay
        self.min_delay = 0.1     # Reduced minimum delay
        self.max_delay = 5.0     # Reduced maximum delay
        ...
        with self.lock:
            ...
            if success:
                ...
                self.current_delay = min(
                    self.max_delay,
                    self.current_delay * 1.5  # Less aggressive backoff
                )
...
Output {batch_size} lines of JSON only, no additional text."""
    ...
    def generate_samples(self,
                        ...
                        num_needed: int,
                        used_samples: Set[str]) -> List[Dict]:
        """Generate all needed samples using parallel processing."""
